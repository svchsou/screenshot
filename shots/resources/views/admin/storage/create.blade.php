...
@section('content')
  <div class="mui-panel" style="max-width:820px; margin:0 auto;">
    <h1 class="mui--text-headline" style="margin-top:0">Add Storage Destination</h1>
    <form id="destForm" method="POST" action="{{ route('admin.storage.store') }}">
      @csrf
      ...
      <!-- Dynamic sections -->
      <div id="section-local" class="type-section">
        <div class="mui-textfield"><label>Root Path</label>
          <input type="text" id="local_root" placeholder="C:/wamp64/www/uploads">
        </div>
        <div class="mui--text-caption">
          @php($hasWritable = is_dir('C:/wamp64/www') || true)
          Ensure the path exists and PHP has write permission.
        </div>
      </div>

      <div id="section-ftp" class="type-section mui--hide">
        <div class="mui-textfield"><label>Host</label><input type="text" id="ftp_host" placeholder="ftp.example.com"></div>
        <div class="mui-textfield"><label>Username</label><input type="text" id="ftp_username"></div>
        <div class="mui-textfield"><label>Password</label><input type="password" id="ftp_password"></div>
        <div class="mui-textfield"><label>Root Path</label><input type="text" id="ftp_root" placeholder="/public_html/uploads"></div>
        <div class="mui-row">
          <div class="mui-col-sm-4 mui-textfield"><label>Port</label><input type="number" id="ftp_port" value="21"></div>
          <div class="mui-col-sm-4 mui-checkbox" style="margin-top:28px"><label><input type="checkbox" id="ftp_ssl"> SSL</label></div>
          <div class="mui-col-sm-4 mui-checkbox" style="margin-top:28px"><label><input type="checkbox" id="ftp_passive" checked> Passive</label></div>
        </div>
        <div class="mui-textfield"><label>Timeout (s)</label><input type="number" id="ftp_timeout" value="30"></div>
        <div class="mui--text-caption">
      ...
      <div id="section-s3" class="type-section mui--hide">
        <div class="mui-textfield"><label>Access Key</label><input type="text" id="s3_key"></div>
        <div class="mui-textfield"><label>Secret</label><input type="password" id="s3_secret"></div>
        <div class="mui-textfield"><label>Region</label><input type="text" id="s3_region" placeholder="ap-southeast-1"></div>
        <div class="mui-textfield"><label>Bucket</label><input type="text" id="s3_bucket"></div>
        <div class="mui-textfield"><label>Endpoint</label><input type="text" id="s3_endpoint" placeholder="https://sgp1.digitaloceanspaces.com"></div>
        <div class="mui-textfield"><label>Public URL (optional)</label><input type="text" id="s3_url" placeholder="https://cdn.example.com"></div>
        <div class="mui-textfield"><label>Prefix/Root (optional)</label><input type="text" id="s3_root" placeholder="uploads"></div>
        <div class="mui-checkbox"><label><input type="checkbox" id="s3_use_path_style"> Use Path Style</label></div>
        <div class="mui--text-caption">
      ...
      <textarea id="credentials" name="credentials" class="mui--hide">{}</textarea>
  ...
  (function(){
    ...
    // We actually have three sections: local, ftp, s3 (used for both s3 and spaces)
